      ...
      <TransitionRoot as="template" :show="mobileFiltersOpen">
        ...
        >
          ...
          <div class="fixed inset-0 flex z-40">
            ...
            >
              <DialogPanel
                class="ml-auto relative max-w-xs w-full h-full bg-gray-200 shadow-xl py-4 pb-12 flex flex-col overflow-y-auto"
              >
                <div class="px-4 flex items-center justify-between">
                  <h2 class="text-lg font-medium text-gray-900">Filters</h2>
                  <button
                    type="button"
                    class="-mr-2 w-10 h-10 bg-gray-200 p-2 rounded-md flex items-center justify-center text-gray-400"
                ...
                <form class="mt-4 border-t border-gray-200">
                  ...
                  >
                    <h3 class="-mx-2 -my-3 flow-root">
                      <DisclosureButton
                        class="px-2 py-3 bg-gray-200 w-full flex items-center justify-between text-gray-400 hover:text-gray-500"
                      >
        ...
        >
          ...
          <div class="flex items-center">
            <Menu as="div" class="relative inline-block text-left">
              ...
              >
                <MenuItems
                  class="origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-2xl bg-gray-200 ring-1 ring-black ring-opacity-5 focus:outline-none"
                >
                  <div class="py-1">
                    <MenuItem
            ...
            <form class="hidden lg:block">
              ...
              >
                <h3 class="-my-3 flow-root">
                  <DisclosureButton
                    class="py-3 bg-gray-200 w-full flex items-center justify-between text-sm text-gray-400 hover:text-gray-500"
                  >
                    <span class="font-medium text-gray-900">
                      {{ section.name }}
                    </span>
...
import ProuctsList from "./ProuctsList.vue";
